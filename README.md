...
To allow a server to store information about a client. Persist authentication so we don't need to re-enter credentials all the time. 

1. What does bcrypt do to help us store passwords in a secure manner.

Bcrypt does password hashing, implements salt and accumulate hashing rounds.

1. What does bcrypt do to slow down attackers?

Having algorithm that hashes information multiple times means that the attacker needs to know the algorithm used, how many rounds were used to generate the has. All this slows down the attacking process. 
